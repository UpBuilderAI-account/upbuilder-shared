...
exports.CLASS_PATTERNS = exports.HTML_TAG_TO_COMPONENT = void 0;
exports.getComponentType = getComponentType;
exports.getDefaultTag = getDefaultTag;
exports.getXSCPType = getXSCPType;
exports.matchesClassPattern = matchesClassPattern;
// -----------------------------------------------------------------------------
 ...
 */
function getComponentType(tag, context) {
    var _a, _b, _c;
    const normalizedTag = tag.toLowerCase();
    // Input type-specific mapping
    if (normalizedTag === 'input') {
        return mapInputType((_a = context === null || context === void 0 ? void 0 : context.attributes) === null || _a === void 0 ? void 0 : _a.type, context);
    }
    // Button element
    if (normalizedTag === 'button') {
        if ((context === null || context === void 0 ? void 0 : context.insideForm) && ((_b = context === null || context === void 0 ? void 0 : context.attributes) === null || _b === void 0 ? void 0 : _b.type) === 'submit') {
            return 'FormButton';
        }
        return 'Button';
    }
    ...
    if (normalizedTag === 'nav') {
        if (context === null || context === void 0 ? void 0 : context.insideNavbar) {
            return 'NavbarMenu';
        }
        if (context === null || context === void 0 ? void 0 : context.insideDropdown) {
            return 'DropdownList';
        }
        return 'Block';
    }
    ...
    if (normalizedTag === 'label') {
        ...
        if ((context === null || context === void 0 ? void 0 : context.parentType) === 'FormCheckboxWrapper' || (context === null || context === void 0 ? void 0 : context.parentType) === 'FormRadioWrapper') {
    ...
    if (normalizedTag === 'form') {
        ...
        if ((_c = context === null || context === void 0 ? void 0 : context.classes) === null || _c === void 0 ? void 0 : _c.some(c => c.includes('search'))) {
            return 'SearchForm';
        }
        return 'FormForm';
    }
    // Default lookup
    return exports.HTML_TAG_TO_COMPONENT[normalizedTag] || 'Block';
}
/**
 * Map input element based on type attribute
 */
function mapInputType(type, context) {
    switch (type) {
        case 'text':
        case 'email':
        case 'password':
        ...
        case 'submit':
            if ((context === null || context === void 0 ? void 0 : context.parentType) === 'SearchForm') {
                return 'SearchButton';
            }
            return 'FormButton';
        case 'search':
 ...
 */
function mapAnchorElement(context) {
    var _a, _b;
    // Inside navbar
    if (context === null || context === void 0 ? void 0 : context.insideNavbar) {
        // Check if it's a brand link
        if ((_a = context.classes) === null || _a === void 0 ? void 0 : _a.some(c => c.includes('brand') || c.includes('logo'))) {
            return 'NavbarBrand';
        }
        return 'NavbarLink';
    }
    ...
    // Inside tabs
    if ((context === null || context === void 0 ? void 0 : context.parentType) === 'TabsMenu') {
        return 'TabsLink';
    }
    // Button-styled link
    if ((_b = context === null || context === void 0 ? void 0 : context.classes) === null || _b === void 0 ? void 0 : _b.some(c => c.includes('button') || c.includes('btn'))) {
        return 'Button';
    }
    return 'Link';
}
 ...
 */
function getXSCPType(componentType) {
 ...
 */
function matchesClassPattern(classes, patternKey) {
    const patterns = exports.CLASS_PATTERNS[patternKey];
