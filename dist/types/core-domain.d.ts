...
export type ProjectStatus = 'idle' | 'load' | 'detect_sections' | 'styles_config' | 'generate_styles' | 'prepare_build' | 'build' | 'consolidate_css' | 'consolidate_scripts' | 'customize' | 'export' | 'complete' | 'failed';
/**
