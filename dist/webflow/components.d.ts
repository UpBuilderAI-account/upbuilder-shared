...
export type ComponentCategory = 'basic' | 'typography' | 'navigation' | 'dropdown' | 'tabs' | 'slider' | 'form' | 'search' | 'media' | 'text-formatting' | 'cms' | 'layout-grid' | 'video';
export declare const WEBFLOW_COMPONENTS: {
    readonly Row: {
        readonly displayName: "Row";
        readonly tags: readonly ["div"];
        readonly isContainer: true;
        readonly category: "layout-grid";
        readonly specialDataFields: readonly ["grid"];
        readonly description: "Legacy 12-column grid row, contains Column children";
    };
    readonly Column: {
        ...
        readonly category: "layout-grid";
        readonly specialDataFields: readonly ["grid"];
        readonly description: "Column inside Row, part of legacy grid system";
    };
    readonly Grid: {
        ...
        readonly category: "layout-grid";
        readonly specialDataFields: readonly ["grid"];
        readonly description: "CSS Grid layout container";
    };
    readonly HFlex: {
        readonly displayName: "H Flex";
        readonly tags: readonly ["div"];
        readonly isContainer: true;
        readonly category: "basic";
        readonly specialDataFields: readonly [];
        readonly description: "Horizontal flexbox container (Quick Stack horizontal)";
    };
    readonly VFlex: {
        readonly displayName: "V Flex";
        readonly tags: readonly ["div"];
        readonly isContainer: true;
        readonly category: "basic";
        readonly specialDataFields: readonly [];
        readonly description: "Vertical flexbox container (Quick Stack vertical)";
    };
    readonly Block: {
    ...
    readonly HamburgerIcon: {
        readonly displayName: "Hamburger Icon";
        readonly tags: readonly ["div"];
        readonly isContainer: false;
        readonly category: "media";
        readonly specialDataFields: readonly ["widget"];
        readonly description: "Hamburger menu icon for navbar toggle";
    };
    readonly HtmlEmbed: {
    ...
    readonly NavbarWrapper: {
        ...
        readonly description: "Navbar wrapper, contains NavbarBrand, NavbarMenu, NavbarButton";
    };
    ...
    readonly SwiperSlider: {
        readonly displayName: "Swiper Slider";
        readonly tags: readonly ["div"];
        readonly isContainer: true;
        readonly category: "slider";
        readonly specialDataFields: readonly ["swiper"];
        readonly description: "Swiper slider container - wraps .swiper element";
    };
    readonly SwiperSlide: {
        readonly displayName: "Swiper Slide";
        readonly tags: readonly ["div"];
        readonly isContainer: true;
        readonly category: "slider";
        readonly specialDataFields: readonly ["swiper"];
        readonly description: "Individual slide - wraps .swiper-slide element";
    };
    readonly SwiperNavPrev: {
        readonly displayName: "Swiper Nav Prev";
        readonly tags: readonly ["div"];
        readonly isContainer: true;
        readonly category: "slider";
        readonly specialDataFields: readonly ["swiper"];
        readonly description: "Previous navigation button (optional, auto-generated if navigation=true)";
    };
    readonly SwiperNavNext: {
        readonly displayName: "Swiper Nav Next";
        readonly tags: readonly ["div"];
        readonly isContainer: true;
        readonly category: "slider";
        readonly specialDataFields: readonly ["swiper"];
        readonly description: "Next navigation button (optional, auto-generated if navigation=true)";
    };
    readonly SwiperPagination: {
        readonly displayName: "Swiper Pagination";
        readonly tags: readonly ["div"];
        readonly isContainer: false;
        readonly category: "slider";
        readonly specialDataFields: readonly ["swiper"];
        readonly description: "Pagination dots/bullets (optional, auto-generated if pagination=true)";
    };
    readonly SwiperScrollbar: {
        readonly displayName: "Swiper Scrollbar";
        readonly tags: readonly ["div"];
        readonly isContainer: false;
        readonly category: "slider";
        readonly specialDataFields: readonly ["swiper"];
        readonly description: "Scrollbar (optional, auto-generated if scrollbar=true)";
    };
    ...
    readonly BackgroundVideoWrapper: {
        readonly displayName: "Background Video";
        readonly tags: readonly ["div"];
        readonly isContainer: true;
        readonly category: "video";
        readonly specialDataFields: readonly ["bgvideo", "attr"];
        readonly description: "Background video container with autoplay support";
    };
    readonly BackgroundVideoPlayPauseButton: {
        readonly displayName: "BG Video Button";
        readonly tags: readonly ["div"];
        readonly isContainer: true;
        readonly category: "video";
        readonly specialDataFields: readonly ["attr"];
        readonly description: "Play/pause toggle button for background video";
    };
    readonly BackgroundVideoPlayPauseButtonPlaying: {
        readonly displayName: "BG Video Playing State";
        readonly tags: readonly ["div"];
        readonly isContainer: true;
        readonly category: "video";
        readonly specialDataFields: readonly [];
        readonly description: "State shown when video is playing (pause icon)";
    };
    readonly BackgroundVideoPlayPauseButtonPaused: {
        readonly displayName: "BG Video Paused State";
        readonly tags: readonly ["div"];
        readonly isContainer: true;
        readonly category: "video";
        readonly specialDataFields: readonly [];
        readonly description: "State shown when video is paused (play icon)";
    };
    readonly DynamoWrapper: {
        readonly displayName: "Collection List Wrapper";
        readonly tags: readonly ["div"];
        readonly isContainer: true;
        readonly category: "cms";
        readonly specialDataFields: readonly ["dyn"];
        readonly description: "Outer wrapper for CMS collection list, contains DynamoList and DynamoEmpty";
    };
    readonly DynamoList: {
        ...
        readonly category: "cms";
        readonly specialDataFields: readonly ["dyn"];
        readonly description: "CMS collection list, contains DynamoItem elements";
    };
    readonly DynamoItem: {
...
export declare const COMPONENTS_BY_CATEGORY: {
    readonly basic: ("RichText" | "Image" | "Video" | "Link" | "Row" | "Column" | "Grid" | "Section" | "Button" | "List" | "Icon" | "Heading" | "Paragraph" | "Span" | "Figure" | "Strong" | "Emphasized" | "Superscript" | "Subscript" | "Strikethrough" | "Underline" | "HFlex" | "VFlex" | "Block" | "BlockContainer" | "LinkBlock" | "TextLink" | "ListItem" | "HamburgerIcon" | "HtmlEmbed" | "CodeBlock" | "LineBreak" | "Blockquote" | "Figcaption" | "InlineCode" | "NavbarWrapper" | "NavbarBrand" | "NavbarMenu" | "NavbarLink" | "NavbarButton" | "DropdownWrapper" | "DropdownToggle" | "DropdownList" | "DropdownLink" | "TabsWrapper" | "TabsMenu" | "TabsContent" | "TabsLink" | "TabsPane" | "SwiperSlider" | "SwiperSlide" | "SwiperNavPrev" | "SwiperNavNext" | "SwiperPagination" | "SwiperScrollbar" | "FormWrapper" | "FormForm" | "FormBlockLabel" | "FormTextInput" | "FormTextarea" | "FormSelect" | "FormButton" | "FormCheckboxWrapper" | "FormCheckboxInput" | "FormRadioWrapper" | "FormRadioInput" | "FormInlineLabel" | "FormSuccessMessage" | "FormErrorMessage" | "FormFileUploadWrapper" | "FormFileUploadDefault" | "FormFileUploadUploading" | "FormFileUploadSuccess" | "FormFileUploadError" | "FormFileUploadInput" | "FormFileUploadLabel" | "FormFileUploadErrorMsg" | "FormReCaptcha" | "SearchForm" | "SearchInput" | "SearchButton" | "LightboxWrapper" | "MapWidget" | "BackgroundVideoWrapper" | "BackgroundVideoPlayPauseButton" | "BackgroundVideoPlayPauseButtonPlaying" | "BackgroundVideoPlayPauseButtonPaused" | "DynamoWrapper" | "DynamoList" | "DynamoItem" | "DynamoEmpty")[];
    ...
    readonly 'layout-grid': ("RichText" | "Image" | "Video" | "Link" | "Row" | "Column" | "Grid" | "Section" | "Button" | "List" | "Icon" | "Heading" | "Paragraph" | "Span" | "Figure" | "Strong" | "Emphasized" | "Superscript" | "Subscript" | "Strikethrough" | "Underline" | "HFlex" | "VFlex" | "Block" | "BlockContainer" | "LinkBlock" | "TextLink" | "ListItem" | "HamburgerIcon" | "HtmlEmbed" | "CodeBlock" | "LineBreak" | "Blockquote" | "Figcaption" | "InlineCode" | "NavbarWrapper" | "NavbarBrand" | "NavbarMenu" | "NavbarLink" | "NavbarButton" | "DropdownWrapper" | "DropdownToggle" | "DropdownList" | "DropdownLink" | "TabsWrapper" | "TabsMenu" | "TabsContent" | "TabsLink" | "TabsPane" | "SwiperSlider" | "SwiperSlide" | "SwiperNavPrev" | "SwiperNavNext" | "SwiperPagination" | "SwiperScrollbar" | "FormWrapper" | "FormForm" | "FormBlockLabel" | "FormTextInput" | "FormTextarea" | "FormSelect" | "FormButton" | "FormCheckboxWrapper" | "FormCheckboxInput" | "FormRadioWrapper" | "FormRadioInput" | "FormInlineLabel" | "FormSuccessMessage" | "FormErrorMessage" | "FormFileUploadWrapper" | "FormFileUploadDefault" | "FormFileUploadUploading" | "FormFileUploadSuccess" | "FormFileUploadError" | "FormFileUploadInput" | "FormFileUploadLabel" | "FormFileUploadErrorMsg" | "FormReCaptcha" | "SearchForm" | "SearchInput" | "SearchButton" | "LightboxWrapper" | "MapWidget" | "BackgroundVideoWrapper" | "BackgroundVideoPlayPauseButton" | "BackgroundVideoPlayPauseButtonPlaying" | "BackgroundVideoPlayPauseButtonPaused" | "DynamoWrapper" | "DynamoList" | "DynamoItem" | "DynamoEmpty")[];
    readonly video: ("RichText" | "Image" | "Video" | "Link" | "Row" | "Column" | "Grid" | "Section" | "Button" | "List" | "Icon" | "Heading" | "Paragraph" | "Span" | "Figure" | "Strong" | "Emphasized" | "Superscript" | "Subscript" | "Strikethrough" | "Underline" | "HFlex" | "VFlex" | "Block" | "BlockContainer" | "LinkBlock" | "TextLink" | "ListItem" | "HamburgerIcon" | "HtmlEmbed" | "CodeBlock" | "LineBreak" | "Blockquote" | "Figcaption" | "InlineCode" | "NavbarWrapper" | "NavbarBrand" | "NavbarMenu" | "NavbarLink" | "NavbarButton" | "DropdownWrapper" | "DropdownToggle" | "DropdownList" | "DropdownLink" | "TabsWrapper" | "TabsMenu" | "TabsContent" | "TabsLink" | "TabsPane" | "SwiperSlider" | "SwiperSlide" | "SwiperNavPrev" | "SwiperNavNext" | "SwiperPagination" | "SwiperScrollbar" | "FormWrapper" | "FormForm" | "FormBlockLabel" | "FormTextInput" | "FormTextarea" | "FormSelect" | "FormButton" | "FormCheckboxWrapper" | "FormCheckboxInput" | "FormRadioWrapper" | "FormRadioInput" | "FormInlineLabel" | "FormSuccessMessage" | "FormErrorMessage" | "FormFileUploadWrapper" | "FormFileUploadDefault" | "FormFileUploadUploading" | "FormFileUploadSuccess" | "FormFileUploadError" | "FormFileUploadInput" | "FormFileUploadLabel" | "FormFileUploadErrorMsg" | "FormReCaptcha" | "SearchForm" | "SearchInput" | "SearchButton" | "LightboxWrapper" | "MapWidget" | "BackgroundVideoWrapper" | "BackgroundVideoPlayPauseButton" | "BackgroundVideoPlayPauseButtonPlaying" | "BackgroundVideoPlayPauseButtonPaused" | "DynamoWrapper" | "DynamoList" | "DynamoItem" | "DynamoEmpty")[];
};
/** Count of components */
