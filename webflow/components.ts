...
export const ALL_COMPONENT_TYPES = Object.keys(WEBFLOW_COMPONENTS) as WebflowComponentType[];

/** Get component definition by type */
export function getComponentDef(type: WebflowComponentType): WebflowComponentDef {
  return WEBFLOW_COMPONENTS[type];
}

/** Check if a string is a valid component type */
export function isValidComponentType(type: string): type is WebflowComponentType {
  return type in WEBFLOW_COMPONENTS;
}
...
export function getComponentsByCategory(category: ComponentCategory): WebflowComponentType[] {
  return ALL_COMPONENT_TYPES.filter(type => WEBFLOW_COMPONENTS[type].category === category);
}
...
/** Count of components */
export const COMPONENT_COUNT = ALL_COMPONENT_TYPES.length;
