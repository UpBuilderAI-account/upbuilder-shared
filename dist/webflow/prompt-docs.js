...
exports.generateDropdownHierarchyDocs = generateDropdownHierarchyDocs;
...
exports.generateCompletePromptDocs = generateCompletePromptDocs;
exports.generateCompactHierarchyRules = generateCompactHierarchyRules;
exports.generateMinimalComponentList = generateMinimalComponentList;
 ...
 */
function generateComponentListForPrompt() {
    const categories = [
    ...
    const lines = ['## Valid compType Values\n'];
    for (const { key, name } of categories) {
        const components = components_1.COMPONENTS_BY_CATEGORY[key];
 ...
 */
function generateComponentTableForPrompt() {
    const lines = [
        '## Component Types Reference\n',
        '| compType | HTML Tag | Description |',
        '|----------|----------|-------------|',
    ];
    for (const [type, def] of Object.entries(components_1.WEBFLOW_COMPONENTS)) {
 ...
 */
function generateNavbarHierarchyDocs() {
 ...
 */
function generateDropdownHierarchyDocs() {
 ...
 */
function generateTabsHierarchyDocs() {
 ...
 */
function generateSliderHierarchyDocs() {
 ...
 */
function generateFormHierarchyDocs() {
 ...
 */
function generateAllHierarchyDocs() {
    return [
 ...
 */
function generateCompletePromptDocs() {
    return [
        generateComponentListForPrompt(),
        '',
        (0, breakpoints_1.generateBreakpointDocsForPrompt)(),
        '',
        (0, breakpoints_1.generateStateDocsForPrompt)(),
        '',
 ...
 */
function generateCompactHierarchyRules() {
 ...
 */
function generateMinimalComponentList() {
...
exports.COMPLETE_PROMPT_DOCS = generateCompletePromptDocs();
/** Pre-built hierarchy documentation */
exports.ALL_HIERARCHY_DOCS = generateAllHierarchyDocs();
/** Pre-built compact rules */
exports.COMPACT_HIERARCHY_RULES = generateCompactHierarchyRules();
/** Pre-built component list */
exports.COMPONENT_LIST = generateComponentListForPrompt();
/** Pre-built component table */
exports.COMPONENT_TABLE = generateComponentTableForPrompt();
/** Pre-built validation checklist */
exports.VALIDATION_CHECKLIST = generateValidationChecklist();
// Individual hierarchy docs (for selective inclusion)
exports.NAVBAR_HIERARCHY_DOCS = generateNavbarHierarchyDocs();
exports.DROPDOWN_HIERARCHY_DOCS = generateDropdownHierarchyDocs();
