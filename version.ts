 ...
 */
export const SHARED_VERSION = '2.1.102';
 ...
 */
export function isVersionCompatible(_pluginVersion: string): boolean {
 ...
 */
export function getVersionMismatchMessage(pluginVersion: string): string {
  return `Plugin version (${pluginVersion}) is outdated. Current version is ${SHARED_VERSION}. Please close this Figma tab and open a new one to update the plugin.`;
}
