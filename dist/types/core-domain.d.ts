...
export type ProjectStatus = 'idle' | 'analyze_design' | 'images_export' | 'export_config' | 'load' | 'plan' | 'section_bounding' | 'build_styles' | 'build_sections' | 'assembly' | 'convert_to_platform' | 'customize' | 'complete' | 'failed';
/**
